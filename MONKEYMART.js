...
noExitRuntime = true;
run();</script></head>
    <body __processed_f52095e0-628f-4537-b074-815e97293502__="true" bis_register="">
        <div id="app-container" class="canvas-app-container" bis_skin_checked="1" style="width: 603px; height: 695px;">
            <div id="canvas-container" class="canvas-app-canvas-container" bis_skin_checked="1">
                <canvas id="canvas" class="canvas-app-canvas" tabindex="1" width="753" height="868"></canvas>
            </div>
            <div class="buttons-background" bis_skin_checked="1"></div>
            <!-- center and anchor to bottom of page -->
            <div id="progress-bar-root" style="position: absolute; bottom: 56px; left: 50%; visibility: hidden; z-index: 4;" bis_skin_checked="1">
                <!-- <div id="progress-bar-text"> -->
                <img id="progress-bar-bg" src="load_bar_bg.png" width="453" style="margin-left: -226.5px;">
                <img id="progress-bar-fg" src="load_bar_fg.png" style="position: absolute; clip: rect(0px, 536.067px, 42px, 0px); margin-top: 0px; margin-left: -453px;" width="453">
            </div>
        </div>
        <!-- -->
...
<div class="iframeClose active" id="iframeClose" bis_skin_checked="1"></div></body></html>